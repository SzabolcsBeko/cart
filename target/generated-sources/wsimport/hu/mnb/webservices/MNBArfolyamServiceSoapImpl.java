 ...
 * 
 */
@WebServiceClient(name = "MNBArfolyamServiceSoapImpl", targetNamespace = "http://www.mnb.hu/webservices/", wsdlLocation = "/wsdl/arfolyamok.wsdl")
    ...
    extends Service
{
    ...
    static {
        MNBARFOLYAMSERVICESOAPIMPL_WSDL_LOCATION = hu.mnb.webservices.MNBArfolyamServiceSoapImpl.class.getResource("/wsdl/arfolyamok.wsdl");
        WebServiceException e = null;
        if (MNBARFOLYAMSERVICESOAPIMPL_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find '/wsdl/arfolyamok.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
